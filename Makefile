...
# Charm variables
CHARM_NAME := thruk
CHARM_STORE_URL := cs:~huntdatacenter/thruk
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-thruk/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-thruk/issues
